...
/**
 * Filter wrapper around WordPress core PostFeaturedImage component.
 */
const withFeaturedImageAI = createHigherOrderComponent(
	( OriginalComponent ) => {
		return ( props ) => {
			...
			// Dynamic capabilities checklist configuration
			...
			return (
				<Fragment>
					...
					{ /* Lock search type constraint parameter to 'image' for featured fields */ }
					{ isStockOpen && (
						<StockPhotoModal
							isOpen={ isStockOpen }
